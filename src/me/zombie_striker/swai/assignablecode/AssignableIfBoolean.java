...
public class AssignableIfBoolean extends AssignableCode implements  AssignableIf{

    private PersonalityMatrix matrix;
    private int pallet1;
    private int pallet2;

    public AssignableIfBoolean(PersonalityMatrix matrix, int palletIndex1 , int palletIndex2) {
        super("IFBOOL");
        this.matrix = matrix;
    ...
    public boolean compare(){
        ...
        if(matrix.getCode()[pallet1] instanceof AssignableField && matrix.getCode()[pallet2] instanceof AssignableField) {
            ...
            if (field1.getObjectInstance()%2 == field2.getObjectInstance()%2) {
                return true;
            }
        }
        return false;
    ...
    public String toString() {
        return "IFBOOL ("+pallet1+","+pallet2+") {";
    }

    @Override
    public AssignableCode clone(PersonalityMatrix matrix) {
        return new AssignableIfBoolean(matrix,pallet1,pallet2);
    }
