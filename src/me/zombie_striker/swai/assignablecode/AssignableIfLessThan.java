...
public class AssignableIfLessThan extends AssignableCode{
    ...
    public AssignableIfLessThan(PersonalityMatrix matrix, int palletIndex1 , int palletIndex2, int skippableLines) {
        super("IFLESSTHAN");
        this.matrix = matrix;
    ...
    public AssignableCode clone(PersonalityMatrix matrix) {
        return new AssignableIfLessThan(matrix,pallet1,pallet2,skippablelines);
    }
