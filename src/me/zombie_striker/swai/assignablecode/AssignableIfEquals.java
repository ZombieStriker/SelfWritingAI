...
public class AssignableIfEquals extends AssignableCode implements  AssignableIf {

    private PersonalityMatrix matrix;
    private int pallet1;
    private int pallet2;

    public AssignableIfEquals(PersonalityMatrix matrix, int palletIndex1, int palletIndex2) {
        super("IFEQUALS");
        this.matrix = matrix;
    ...
    public String toString() {
        return "IFEQUALS (" + pallet1 + "," + pallet2 + ") {";
    }

    @Override
    public AssignableCode clone(PersonalityMatrix matrix) {
        return new AssignableIfEquals(matrix, pallet1, pallet2);
    }
